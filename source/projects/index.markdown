...
Crawmer's Critterz is a wonderful preschool and daycare located in Bend,
Oregon. I worked with the director, Ruth Crawmer to give the whole organization
a brand new identity and website that brings in a familiar feel but gives it a
fresh touch.

[Visit Crawmer's Critterz][crawmerscritterz]
...
Secure Insurance is a multifaceted agency with a wide range of coverage. They
also provide equine coverages through their sister company [Henry
Equestrian](http://hep.ca/). My job was to create a theme that would carry
through both companies to give the user a consistent look and feel while
traveling between sites. This site is fully responsive with some CSS animation
added here and there for effect.

[Visit Secure Insurance][secureinsurance]
...
experience, vertical rhythm in it's typography, and application performance.
...
innovative for a new insurance website. At the time of starting their design
I decided to utilize a new CSS framework called [Susy][susy] that I had ported over to
our content management system. One particularly successful element in this design was the
"catch-all" banner right above the footer prompting users to take action on
every page increasing conversion.
...
refinement and change to increase visitor interaction and sales. Additionally I
created the entire product backend interface.
...
{% img right /images/projects/mobiquote/mobiquote-mobile.png 250 MobiQuote %}
...
[Visit Demo][mobiquotedemo] or [Visit Product Page][mobiquote]
...
[GitHub Repository](http://github.com/MarioRicalde/SCSS.tmbundle)
...
Compass. I maintain the extension through the Compass team responding to
requests on GitHub.

[GitHub Repository](http://github.com/compass/compass-blueprint)


### Compass-inuit

Based on the [inuit.css](http://inuitcss.com) OOCSS framework, I created a compass extension and actively
maintain and develop it. [8k downloads](https://rubygems.org/gems/compass-inuit) to date!

[GitHub Repository](http://github.com/stephenway/compass-inuit)
...
{% img right https://2.gravatar.com/avatar/948236458bacf1507222fca98b170a4e?s=140 140 Agency Revolution %}
...
{% img right https://1.gravatar.com/avatar/72be0dc5d280cd00c439ddecf989b9db?s=140 140 Agency Revolution %}
...
[Visit Compass][compass]

## [HTML5 Boilerplate](http://github.com/h5bp?tab=members)

{% img right https://1.gravatar.com/avatar/7ac667bbdc0a30eaf671479cc06afe92?s=140 140 Agency Revolution %}

On the [Effeckt.css][effeckt] team pioneering 60fps CSS animated web components in Sass.

[Visit HTML5 Boilerplace][h5bp]

---

# Get in Touch

{% img left https://0.gravatar.com/avatar/b73f3053f83f571a73a19121cb164b7b?s=140 140 Stephen Way %}

Want to chat? I am available for new projects.
...
[crawmerscritterz]: http://www.bendpreschool.com/
[effeckt]:          http://h5bp.github.io/Effeckt.css/dist/
